...
class BrresModel(QAbstractItemModel):
    def __init__(self, headers, data, parent=None):
        super(BrresModel, self).__init__(parent)

        rootData = [header for header in headers]
        self.rootItem = BrresItem(rootData)
    ...
    def flags(self, index):
        ...
        return Qt.ItemIsEditable | super(BrresModel, self).flags(index)
